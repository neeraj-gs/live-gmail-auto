  ...
  return (
    <>
      ...
      <h1 className='font-semibold text-lg text-center mt-2'>
        A Node.js Backend Project that<br /> <span className="font-bold text-green-600"> Automatically Replies</span> to Mails When User is Unable to send mails &nbsp; <br />
      ...
      <footer className="mt-20 ml-16 font-bold">
        <a className="underline text-blue-500" href="https://github.com/neeraj-gs/Gmail-Auto-Reply" target="_blank">Download Source Code</a>
